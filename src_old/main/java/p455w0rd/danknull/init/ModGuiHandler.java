...
public class ModGuiHandler implements IGuiHandler {
	...
	public static void launchGui(GUIType type, EntityPlayer playerIn, World worldIn, BlockPos pos) {
		playerIn.openGui(DankNull.INSTANCE, type.ordinal(), worldIn, pos.getX(), pos.getY(), pos.getZ());
	}
