...
public class ModGlobals {
	...
	public static final String DEPENDANCIES = "required-after:" + MODID_PWLIB + "@[2.1.44,);required-after:codechickenlib@[3.2.1.353,);after:stg;after:jei;after:waila;after:theoneprobe;after:nei";
