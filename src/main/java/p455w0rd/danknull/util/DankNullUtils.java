...
//	}
	...
	public static boolean canStackBeAdded(final ItemStack dankNull, final ItemStack stack) { // TODO Check
		if (isDankNull(dankNull)) {
...
//	}
	...
	public static void renderHUD(final Minecraft mc, final ScaledResolution scaledRes) {
		...
		if (!currentItem.isEmpty() && isDankNull(currentItem)) {
			IDankNullHandler dankNullHandler = currentItem.getCapability(CapabilityDankNull.DANK_NULL_CAPABILITY, null);
